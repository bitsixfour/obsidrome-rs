...
var FileTrieNode = class _FileTrieNode {
  ...
  get slug() {
    const path9 = joinSegments(...this.slugSegments);
    if (this.isFolder) {
      return joinSegments(path9, "index");
    }
    return path9;
  }
  get slugSegment() {
  ...
  makeChild(path9, file) {
    const fullPath = [...this.slugSegments, path9[0]];
  ...
  insert(path9, file) {
    ...
    this.isFolder = true;
    const segment = path9[0];
    if (path9.length === 1) {
      if (segment === "index") {
        this.data ??= file;
      } else {
        this.makeChild(path9, file);
      }
    } else if (path9.length > 1) {
      const child = this.children.find((c) => c.slugSegment === segment) ?? this.makeChild(path9, void 0);
      const fileParts = file.filePath.split("/");
      child.fileSegmentHint = fileParts.at(-path9.length);
      child.insert(path9.slice(1), file);
    }
  }
  ...
  findNode(path9) {
    if (path9.length === 0 || path9.length === 1 && path9[0] === "index") {
      return this;
    }
    return this.children.find((c) => c.slugSegment === path9[0])?.findNode(path9.slice(1));
  }
  ancestryChain(path9) {
    if (path9.length === 0 || path9.length === 1 && path9[0] === "index") {
      return [this];
    }
    const child = this.children.find((c) => c.slugSegment === path9[0]);
    if (!child) {
      return void 0;
    }
    const childPath = child.ancestryChain(path9.slice(1));
    if (!childPath) {
      return void 0;
    }
   ...
   */
  getFolderPaths() {
    return this.entries().filter(([_, node]) => node.isFolder).map(([path9, _]) => path9);
  }
};
...
var FolderContent_default = /* @__PURE__ */ __name(((opts) => {
  const options2 = { ...defaultOptions5, ...opts };
...
var write = /* @__PURE__ */ __name(async ({ ctx, slug, ext, content }) => {
  ...
  const dir = path3.dirname(pathToPage);
...
var Head_default = /* @__PURE__ */ __name((() => {
  const Head = /* @__PURE__ */ __name(({
    ...
    const baseDir = fileData.slug === "404" ? path9 : pathToRoot(fileData.slug);
...
var Graph_default = /* @__PURE__ */ __name(((opts) => {
  const Graph = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    const localGraph = { ...defaultOptions7.localGraph, ...opts?.localGraph };
    const globalGraph = { ...defaultOptions7.globalGraph, ...opts?.globalGraph };
    return /* @__PURE__ */ jsxs15("div", { class: classNames(displayClass, "graph"), children: [
      /* @__PURE__ */ jsx26("h3", { children: "music data" }),
...
var Footer_default = /* @__PURE__ */ __name(((opts) => {
  const Footer = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ jsxs18("footer", { class: `${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsx29("p", { children: /* @__PURE__ */ jsx29("a", { children: " " }) }),
...
var defaultContentPageLayout = {
  ...
  left: [
    ConditionalRender_default({
      component: PageTitle_default(),
      condition: /* @__PURE__ */ __name((page) => page.fileData.slug !== "index", "condition")
    }),
    ConditionalRender_default({
      component: MobileOnly_default(Spacer_default()),
      condition: /* @__PURE__ */ __name((page) => page.fileData.slug !== "index", "condition")
    }),
    Flex_default({
      ...
      if (!containsIndex) {
        console.log(
          styleText3(
            "yellow",
            `
Warning: you seem to be missing an \`index.md\` home page file at the root of your \`${ctx.argv.directory}\` folder (\`${path4.join(ctx.argv.directory, "index.md")} does not exist\`). This may cause errors when deploying.`
          )
        );
      }
    },
...
function _getFolders(slug) {
  var folderName = path5.dirname(slug ?? "");
  const parentFolderNames = [folderName];
  while (folderName !== ".") {
    folderName = path5.dirname(folderName ?? "");
...
function toPosixPath(fp) {
  return fp.split(path6.sep).join("/");
}
...
var Assets = /* @__PURE__ */ __name(() => {
  return {
    ...
    async *partialEmit(ctx, _content, _resources, changeEvents) {
      for (const changeEvent of changeEvents) {
        const ext = path7.extname(changeEvent.path);
        if (ext === ".md") continue;
        if (changeEvent.type === "add" || changeEvent.type === "change") {
...
var NotFoundPage = /* @__PURE__ */ __name(() => {
  ...
  return {
    ...
    async *emit(ctx, _content, resources) {
      ...
      const externalResources = pageResources(path9, resources);
      const componentData = {
        ctx,
        fileData: vfile.data,
        externalResources,
  ...
  return async (processor) => {
    ...
    for (const fp of fps) {
      try {
        ...
        file.data.relativePath = path8.posix.relative(argv.directory, file.path);
